...
export default function ItemDetailPage({ params }) {
  ...
  const minStock =
    availableStocks.length > 0 ? Math.min(...availableStocks) : 0;
      ...
      <div className={styles.detailContainer}>
        <div className={styles.itemDetail}>
          <div className={styles.menuItemType}>
            {menuItem.type.charAt(0).toUpperCase() +
              menuItem.type.slice(1).toLowerCase()}
          </div>
              ...
              <div className={styles.selectedVariationsSection}>
                ...
                <ul className={styles.selectedVariationsList}>
                  {selectedVariations.map((variation) => (
                    <li
                      key={variation.id}
                      className={styles.selectedVariationItem}
                    >
